const styles = {
  ...
  btnPrimary:
    "bg-primary mt-4 py-4 px-6 text-white text-lg minmd:text-2xl font-IBMPlex font-medium rounded-lg hover:shadow-xl transition",
  btnBlack:
  ...
  btnIcon: "w-6 h-6 minmd:w-10 minmd:h-10 object-contain",
  ...
  featureCard:
    "bg-white m-10 p-6 rounded-full shadow-2xl flex justify-around items-center flex-col hover:shadow-lg cursor-pointer w-40 h-40 minlg:w-80 minlg:h-80",
};
